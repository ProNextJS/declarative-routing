...
export function writeRoutes(silent: boolean = false) {
  ...
  let code = `// Automatically generated by declarative-routes, do NOT edit
import { z } from "zod";
...
`;
  ...
  let contents = fs
    .readFileSync(path.resolve(__dirname, "../assets/NEXT-DR-README.md"))
    .toString();
  ...
  fs.writeFileSync("./NEXT-DR-README.md", contents);
}
